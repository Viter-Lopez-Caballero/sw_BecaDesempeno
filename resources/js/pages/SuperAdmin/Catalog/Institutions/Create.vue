...
const submit = () => {
    ...
    alertaCargando('Guardando...', 'Por favor espera mientras se guarda la institución');
    form.post(route(`${props.routeName}store`), {
        onSuccess: () => {
            cerrarAlerta();
            alertaExito('¡Guardado!', 'La institución ha sido creada exitosamente');
        },
        onError: () => {
            cerrarAlerta();
            alertaError('Error', 'Hubo un problema al guardar la institución');
        }
    });
};
</script>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div class="w-full sm:w-auto">
                    ...
                    <div class="flex items-center gap-2 mt-2 text-sm">
                        ...
                        <span class="text-gray-900 font-semibold">Agregar Institución</span>
                    </div>
                </div>
