        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
                    <a :href="route('catalog.sub-areas.export')" class="w-full md:w-auto justify-center px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition flex items-center gap-2 font-medium cursor-pointer">
