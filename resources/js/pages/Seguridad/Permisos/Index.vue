...
const props = defineProps({
    ...
    // permisos: { // Typo in source? Logic uses records
    //   type: Object,
    //   required: true
    // },
    isDarkMode: {
...
const state = reactive({
    filters: {
        page: ref(props.records.current_page),
...
<table class="min-w-full divide-y">
    <thead class="hidden md:table-header-group">
        <tr>
            <th class="px-6 py-3 text-left text-xs font-medium" :class="{'text-white': isDarkMode, 'text-gray-900': isDarkMode, 'uppercase tracking-wider': true}">Icono</th>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium" :class="{'text-white': isDarkMode, 'text-gray-900': isDarkMode, 'uppercase tracking-wider': true}">Key</th>
    ...
    <tbody>
        <tr v-for="item in records.data" :key="item.id" class="flex flex-col md:table-row">
            ...
            <td class="px-6 py-4 text-sm md:table-cell" :class="{'text-white': isDarkMode, 'text-gray-900': isDarkMode}" data-label="Descripcion">{{ item.description }}</td>
            <td class="px-6 py-4 text-sm md:table-cell" :class="{'text-white': isDarkMode, 'text-gray-900': isDarkMode}" data-label= "Key">{{ item.module_key }}</td>
            <td class="px-6 py-4 text-sm md:table-cell" :class="{'text-white': isDarkMode, 'text-gray-900': isDarkMode}" data-label= "Acciones">
