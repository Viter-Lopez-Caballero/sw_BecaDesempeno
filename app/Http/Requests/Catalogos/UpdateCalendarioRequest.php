...
class UpdateCalendarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'publicacion_fin' => ['required', 'date', 'after_or_equal:publicacion_inicio'],
            'registro_inicio' => ['required', 'date', 'after_or_equal:publicacion_fin'],
    ...
    public function messages(): array
    {
        return [
            ...
            'publicacion_fin.required' => 'La fecha de fin de publicación es obligatoria.',
            'publicacion_fin.after_or_equal' => 'La fecha de fin debe ser igual o posterior a la fecha de inicio.',
            'registro_inicio.required' => 'La fecha de inicio de registro es obligatoria.',
            'registro_inicio.after_or_equal' => 'La fecha de inicio de registro debe ser igual o posterior al fin de publicación.',
