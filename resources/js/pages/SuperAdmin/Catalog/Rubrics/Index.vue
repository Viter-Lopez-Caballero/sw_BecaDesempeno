...
const onSearch = _.debounce((value) => {
    router.get(route('catalog.rubrics.index'), {
        search: value,
        rows: rows.value,
...
const cleanFilters = () => {
    ...
    router.get(route('catalog.rubrics.index'), {}, { preserveState: true, replace: true });
};
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div class="w-full sm:w-auto">
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Rúbricas</h1>
                ...
                <Link :href="route('catalog.rubrics.create')" class="w-full sm:w-auto justify-center px-4 py-2.5 bg-[#1B396A] text-white rounded-lg hover:bg-[#0f2347] transition flex items-center gap-2 font-medium cursor-pointer">
