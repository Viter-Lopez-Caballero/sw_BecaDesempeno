                        ...
                        <table class="w-full text-sm text-left">
                            <thead class="bg-[#1B396A] text-white uppercase text-xs font-semibold">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-4 tracking-wider">
                                        <button @click="sortByDocentes('announcement')" class="flex items-center justify-center gap-1 hover:text-gray-200 transition w-full">
                                            <span>Convocatoria</span>
                                            <svg v-if="sortField === 'announcement'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" :class="sortDirection === 'asc' ? 'rotate-0' : 'rotate-180'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                            </svg>
                                        </button>
                                    </th>
