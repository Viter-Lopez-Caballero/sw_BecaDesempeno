    ...
    <style>
        * {
        ...
        .error-container::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #1B396A, #0284c7, #1B396A);
        ...
        .error-code {
            font-size: 140px;
            font-weight: 900;
            background: linear-gradient(135deg, #1B396A 0%, #0284c7 100%);
        ...
        .error-code::after {
            ...
            top: 0;
            z-index: -1;
            background: linear-gradient(135deg, rgba(27, 57, 106, 0.1) 0%, rgba(2, 132, 199, 0.1) 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            filter: blur(15px);
        ...
        .shape-1 {
            width: 200px;
            height: 200px;
            background: linear-gradient(135deg, #1B396A, #0284c7);
            border-radius: 50%;
            top: -50px;
            left: -50px;
            filter: blur(40px);
