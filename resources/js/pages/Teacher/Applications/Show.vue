    ...
    <TeacherLayout>
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <Link :href="route('teacher.dashboard')" class="w-full md:w-auto justify-center px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition flex items-center gap-2 font-medium">
            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg border border-gray-200 p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 gap-x-12 mb-10">
                    ...
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-2">Vía de Solicitud</p>
