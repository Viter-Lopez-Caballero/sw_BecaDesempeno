...
const estadoOptions = props.states.map(e => ({ label: e.name, value: e.name })); // Changed e.nombre to e.name if State model uses name

const onSearch = debounce((value) => {
    router.get(route('superadmin.control-applications.index'), {
        search: value,
        estado: estado.value,
        rows: rows.value,
...
const cleanFilters = () => {
    ...
    estado.value = '';
    rows.value = 10;
    router.get(route('superadmin.control-applications.index'), {}, { preserveState: true, replace: true });
};
            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-4">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                        <button @click="cleanFilters" class="w-full sm:w-auto justify-center px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 flex items-center gap-2 text-sm font-medium transition">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="currentColor">
                                <path d="M400-240v-80h240v80H400Zm-158 0L15-467l57-57 170 170 366-366 57 57-423 423Zm318-160v-80h240v80H560Zm160-160v-80h240v80H720Z"/>
                            </svg>
                            Limpiar Filtros
                        </button>
                        <button class="w-full sm:w-auto justify-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 flex items-center gap-2 text-sm font-medium transition">
                            <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="currentColor">
