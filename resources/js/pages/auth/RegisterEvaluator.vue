...
const form = useForm({
    ...
    priority_area_id: '',
    sub_area_id: '',
    role_type: 'evaluador' // Hidden field to indicate evaluator registration
});
...
<template>
    <LandingLayout>
        <Head title="Registro de Evaluador" />
            ...
            <div class="max-w-5xl w-full">
                ...
                <div class="bg-white rounded-lg shadow-xl p-5 sm:p-8 md:p-10 space-y-6 sm:space-y-7">
                    ...
                    <div class="text-center">
                        <h2 class="text-2xl sm:text-3xl font-semibold text-[#1B396A]">Registro de Evaluador</h2>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div v-if="!form.errors.password_confirmation" class="flex items-center gap-1 mt-1 text-xs" :class="usuarioExistente ? '' : 'text-gray-500'" :style="usuarioExistente ? 'color: #1B396A' : ''">
                                ...
                                <span v-if="usuarioExistente">Repite la misma contraseña que ingresaste arriba</span>
                                <span v-else>Por favor, confirma tu contraseña</span>
                            </div>
