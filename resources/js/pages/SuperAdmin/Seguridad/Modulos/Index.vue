    ...
    <LayoutAuthenticated>
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <Link v-if="useCan('modules.create')" :href="route(`${routeName}create`)" class="px-4 py-2.5 bg-[#1B396A] text-white rounded-lg hover:bg-[#0f2347] transition flex items-center gap-2 font-medium">
                            ...
                            <tr v-for="(modulo, index) in modulos.data" :key="modulo.id" class="hover:bg-gray-50 transition">
                                ...
                                <td v-if="useCan('modules.edit') || useCan('modules.delete')" class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button v-if="useCan('modules.delete')" @click="deleteModule(modulo.id)" class="p-2 text-red-600 border border-red-600 rounded-full hover:bg-red-600 hover:text-white transition group" title="Eliminar">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor">
