            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2 w-full md:w-auto">
                    <button 
                        ...
                        class="w-full md:w-auto justify-center px-4 py-2.5 bg-[#1B396A] text-white rounded-lg hover:bg-[#0f2347] flex items-center gap-2 font-medium transition shadow-md cursor-pointer"
                    >
