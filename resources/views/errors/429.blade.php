...
@php
    ...
    if (isset($exception) && method_exists($exception, 'getHeaders')) {
        ...
        if (isset($headers['Retry-After'])) {
            $retryAfter = max(1, (int) $headers['Retry-After']);
        }
    }
@endphp
<body>
    <div class="error-container">
        ...
        <div class="error-code" data-text="429">429</div>
        <h1 class="error-title">Demasiadas Solicitudes</h1>
        <p class="error-description">
            Has realizado demasiadas solicitudes en poco tiempo. Por favor, espera unos momentos
            antes de intentarlo nuevamente.
        </p>
        <div class="countdown-wrap">
            <p class="countdown-inline">Puedes intentarlo de nuevo en <span class="countdown-number" id="countdown-number">{{ $retryAfter }}</span> seg</p>
        </div>

        <a href="{{ url('/login') }}" class="btn-home" id="btn-retry" style="pointer-events:none; opacity:0.45;">Volver al Inicio de Sesión</a>
